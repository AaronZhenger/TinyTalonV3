...
public class InfiniteRechargeBall extends GamePieceOnFieldSimulation {
    ...
    public static final GamePieceInfo INFINITE_RECHARGE_BALL_INFO = new GamePieceInfo(
            "Ball", Geometry.createCircle(Units.inchesToMeters(14) / 2), Inches.of(7), Grams.of(142), 3.5, 5, 0.3);
